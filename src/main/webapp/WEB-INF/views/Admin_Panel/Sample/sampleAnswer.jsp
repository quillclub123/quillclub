...
<script>
	...
	document.getElementById('msa').classList.add('sidecolor');
</script>
<div id="wrapper">
	<div class="main-content">
		<div class="row small-spacing">
			<div class="col-lg-12 col-xs-12">
			<button type="button" id="clear_btn" class="btn btn-primary btn-xs margin-bottom-10 waves-effect waves-light" data-toggle="modal" data-target="#question_model">Add Sample Answer</button>
						...
						<table id="questionTable" class="table table-striped table-bordered display dataTable" style="width:100%">
		                  <thead class="bg-primary">
		                     <tr>
		                        ...
		                        <th class="text-white">Sample Answer</th>
	...
	<div class="modal-dialog modal-lg" role="document" style="width: 100%!important; margin: 0px !important;">
		<div class="modal-content" style="height: 100vh;">
			<div class="modal-header">
				...
				<h4 class="modal-title" id="myModalLabel">Add Sample Answer</h4>
			</div>
			<form id="questionform" Name="questionform">
			<div class="modal-body">
				<div class="row">
					<div class="col-md-12">
						<label for="question" class="form-label" style="font-weight: 600">Sample Answer<span class="text-danger ">*</span></label>
...
<div class="modal fade" id="question_full" tabindex="-1" role="dialog" aria-labelledby="myModalLabel">
	<div class="modal-dialog" role="document" style="width: 70% !important;">
		<div class="modal-content">
			<div class="modal-header">
				<h4 class="modal-title" id="myModalLabel">Sample Answer</h4>
			</div>
			<div class="modal-body">
				<div class="row">
					<div class="col-md-12">
...
<input type="hidden" id="sno" name="sno" value="0">
	...
	function data() {
	 ...
	 function deletedata(sno)
		{	 
		 Swal.fire({
			  title: 'Do you want to Delete Sample Answer?',
			  showDenyButton: true,
		...
		function edit(i){
			...
			$.ajax({
				...
				success : function(data) {
					if (data['status'] == 'Success') {
						 $('#question_model').modal('toggle');
						 CKEDITOR.instances['question'].setData(data['data'][0].answer);
					} else {
						Swal.fire({
							icon : 'Opps',
							title : 'Warning!',
			...
			$.ajax({
				...
				success : function(data) {
					if (data['status'] == 'Success') {
						 ...
						 $("#questionFull").html(data['data'][0].answer);
					} 
				}
			});
		}
	       ...
	       {	 
	        Swal.fire({
	       	  ...
	       	  if (result.isConfirmed) {
	       			...
	       			$.ajax({
	       				url : 'updateSampleA', //add  Course  controller name AdminController
	       				type : 'post',
