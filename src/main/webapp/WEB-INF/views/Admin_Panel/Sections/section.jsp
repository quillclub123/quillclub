...
<div id="wrapper">
	<div class="main-content">
		...
		<div class="row small-spacing">
			...
			<button type="button" id="clear_btn" class="btn btn-primary btn-xs margin-bottom-10 waves-effect waves-light" data-toggle="modal" data-target="#section_model">Add Section</button>
